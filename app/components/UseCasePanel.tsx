        ...
        >
          ...
          <Reveal>
            <div>
              ...
              <h2 className="mt-4 text-[30px] leading-[1.12] tracking-[0.08em] text-[#FB876D] md:text-[46px]">
                年間プログラム
              </h2>
              <p className="mt-5 max-w-[820px] text-[15px] leading-[1.9] tracking-[0.1em] text-white/88 md:text-[16px]">
              ...
              <Reveal key={p.id} delay={(index % 4) * 60} variant={index % 2 === 0 ? "left" : "right"}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col gap-3 px-5 pb-6 pt-5 md:px-7 md:pb-7 md:pt-6">
                    ...
                    <p className="flex-1 text-[14px] leading-[1.85] tracking-[0.08em] text-white/92 md:text-[15px]">
                      {p.summary}
                    </p>
                  </div>
                </article>
          ...
          <Reveal delay={120}>
            <div className="mt-14 flex flex-col items-center gap-4 md:mt-20">
              <p className="text-center text-[13px] tracking-[0.12em] text-white/75 md:text-[14px]">
