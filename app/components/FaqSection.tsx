  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[880px]">
            ...
            <div key={group.category}>
              ...
              <div className="mt-5 space-y-3">
                {group.items.map((item) => (
                  <details
                    key={item.q}
                    className="group rounded-[20px] border border-white/20 bg-white/[0.09] backdrop-blur-sm transition-colors open:bg-white/[0.12]"
                  >
        ...
        <p className="mt-12 text-center text-[13px] leading-relaxed tracking-[0.08em] text-white/75 md:mt-14 md:text-[14px]">
