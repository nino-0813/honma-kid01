    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[880px]">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-[30px] leading-[1.15] tracking-[0.08em] text-white md:text-[46px] md:leading-[1.15]">
            よくある質問
          </h2>
        </div>
        ...
        <div className="mt-14 space-y-12 md:mt-16 md:space-y-14">
          {FAQ_GROUPS.map((group) => (
            <div key={group.category}>
              <h3 className="border-b border-white/25 pb-3 text-[15px] font-semibold leading-[1.85] tracking-[0.1em] text-[#FB876D] md:text-[16px] md:tracking-[0.12em]">
                {group.category}
              </h3>
                ...
                {group.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="border-t border-white/15 px-5 pb-5 pt-0 md:px-6 md:pb-6">
                      <p className="text-[15px] leading-[1.85] tracking-[0.1em] text-white/95 md:text-[15px] md:leading-[2] md:tracking-[0.06em]">
        ...
        <p className="mt-12 text-center text-[15px] leading-[1.85] tracking-[0.1em] text-white/80 md:mt-14 md:text-[14px] md:leading-relaxed md:tracking-[0.08em]">
